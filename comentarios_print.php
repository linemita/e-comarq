...
$page_layouts["comentarios_print"] = $layout;
...
$page_layouts["productos_masterprint"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["Principal_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "comentarios" );
