...
class ConnectionManager
{
	...
	{
		return $this->byId( "tienlinea_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "tienlinea_at_localhost";
		$data["connName"] = "tienlinea at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;3306;tienlinea;;1"; //currently unused
		...
		$data["connInfo"][4] = "tienlinea";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Port=3306;Database=tienlinea;OPTION=3";
		...
		$connectionsData["tienlinea_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["calificacion"] = "tienlinea_at_localhost";
		$connectionsIds["categorias"] = "tienlinea_at_localhost";
		$connectionsIds["comentarios"] = "tienlinea_at_localhost";
		$connectionsIds["departamento"] = "tienlinea_at_localhost";
		$connectionsIds["municipio"] = "tienlinea_at_localhost";
		$connectionsIds["productos"] = "tienlinea_at_localhost";
		$connectionsIds["tipopago"] = "tienlinea_at_localhost";
		$connectionsIds["usuario"] = "tienlinea_at_localhost";
		$connectionsIds["Principal"] = "tienlinea_at_localhost";
