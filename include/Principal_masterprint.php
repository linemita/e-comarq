<?php
function DisplayMasterTableInfoForPrint_Principal($params)
{
	global $cman;
	...
	$layout = GetPageLayout("Principal", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("Principal", "masterprint"));
}
