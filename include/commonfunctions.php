...
function checkTableName($shortTName, $type=false)
{
	...
	if ("calificacion" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("categorias" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("comentarios" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("productos" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("tipopago" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("usuario" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Principal" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("comentarios");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="comentarios";
	}
	...
	$strPerm = GetUserPermissions("productos");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="productos";
	}
	$strPerm = GetUserPermissions("tipopago");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="tipopago";
	}
	...
	$strPerm = GetUserPermissions("Principal");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Principal";
	}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="calificacion" && $sUserGroup=="UR")
	{
			return "AS".$extraPerm;
	}
	if($table=="calificacion" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="calificacion" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="categorias" && $sUserGroup=="UR")
	{
			return "S".$extraPerm;
	}
	if($table=="categorias" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="categorias" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="comentarios" && $sUserGroup=="UR")
	{
			return "AEDS".$extraPerm;
	}
	if($table=="comentarios" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="comentarios" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="departamento" && $sUserGroup=="UR")
	{
			return "S".$extraPerm;
	}
	if($table=="departamento" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="departamento" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="municipio" && $sUserGroup=="UR")
	{
			return "S".$extraPerm;
	}
	if($table=="municipio" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="municipio" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="productos" && $sUserGroup=="UR")
	{
			return "AEDS".$extraPerm;
	}
	if($table=="productos" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="productos" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="tipopago" && $sUserGroup=="UR")
	{
			return "S".$extraPerm;
	}
	if($table=="tipopago" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="tipopago" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="usuario" && $sUserGroup=="UR")
	{
			return "ED".$extraPerm;
	}
	if($table=="usuario" && $sUserGroup=="Admin")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="usuario" && $sUserGroup=="<Guest>")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="Principal" && $sUserGroup=="UR")
	{
			return "".$extraPerm;
	}
	if($table=="Principal" && $sUserGroup=="Admin")
	{
			return "".$extraPerm;
	}
	if($table=="Principal" && $sUserGroup=="<Guest>")
	{
			return "S".$extraPerm;
	}
//	default permissions	
...
{
	global $globalEvents;
	$_SESSION["GroupID"] = $data["Rol"];


		$_SESSION["OwnerID"] = $data["Apellidos"];
	$_SESSION["_usuario_OwnerID"] = $data["Apellidos"];
		$_SESSION["_Principal_OwnerID"] = $data["Apellidos"];
