...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "calificacion", "varname" => "calificacion", "connId" => "tienlinea_at_localhost");
		$this->lstTables[] = array("name" => "categorias", "varname" => "categorias", "connId" => "tienlinea_at_localhost");
		$this->lstTables[] = array("name" => "comentarios", "varname" => "comentarios", "connId" => "tienlinea_at_localhost");
		$this->lstTables[] = array("name" => "departamento", "varname" => "departamento", "connId" => "tienlinea_at_localhost");
		$this->lstTables[] = array("name" => "municipio", "varname" => "municipio", "connId" => "tienlinea_at_localhost");
		$this->lstTables[] = array("name" => "productos", "varname" => "productos", "connId" => "tienlinea_at_localhost");
		$this->lstTables[] = array("name" => "tipopago", "varname" => "tipopago", "connId" => "tienlinea_at_localhost");
		$this->lstTables[] = array("name" => "usuario", "varname" => "usuario", "connId" => "tienlinea_at_localhost");
	}
