...
$page_layouts["municipio_print"] = $layout;
...
$page_layouts["departamento_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "municipio" );
